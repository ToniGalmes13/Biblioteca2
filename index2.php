...
<body>
    ...
    <div class="login"><?php echo "<h2>Bienvenido " . $nomUsuario . "</h2>"; ?> <label><a href="logout.php">Log Out</a></label> ---- <label><a href="contacto.php">Contacto</a></label></div>
...
<!--
    <script>
        ...
        let id = document.getElementsByTagName("tr")[fila].cells[6].innerHTML;
        $_GET['idllibre'] = id;

        function indexTabla(x) {


            let fila = x.rowIndex;
            let id = document.getElementsByTagName("tr")[fila].cells[6].innerHTML;
            $_GET['idllibre'] = id;
            window.location = "libro.php?idllibre=" + id;
        ...
        function ajax() {
            ...
            xhttp.open("get", "libro.php?idllibre=" + index, true); //m�todo b�sico para realizar petici�n.
